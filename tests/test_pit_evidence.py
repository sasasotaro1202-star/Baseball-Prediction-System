...
def test_only_official_announcement_can_pass():
    ...
    assert strict_eligible(
        StarterEvidence(EvidenceLevel.OFFICIAL_ANNOUNCEMENT, "2026-09-19T10:00:00+00:00", "team", "Pitcher"),
        cutoff,
    )
...
def test_never_backdate_future_evidence():
    cutoff = "2026-09-19T12:00:00+00:00"
    future = StarterEvidence(EvidenceLevel.OFFICIAL_ANNOUNCEMENT, "2026-09-19T13:00:00+00:00", "team", "Pitcher")
